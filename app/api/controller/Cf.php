...
class Cf
{
    ...
    public function login($uin, $sid = null, $skey = null, $pskey = null, $superkey = null)
    {
        $this->uin = $uin;
        $this->sid = $sid;
        $this->skey = $skey;
        ...
        if ($pskey == null) {
            ...
            $this->cookie_pc = 'uin=o' . $uin . '; skey=' . $skey . '; ptui_loginuin=' . $uin . '; p_skey=' . $pskey . ';';
        }
    }
