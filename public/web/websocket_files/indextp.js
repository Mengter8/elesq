...
function headbeat(ws){
	return setInterval(function(){
					var sendMsg={"genre":"ping","data":""}
...
function fun_sendto() {
    ...
    "" != a && (ws && 1 == ws.readyState ? (ws.send(a), output(NoHtml(chg_emoji(a)), 1), null) : alert("连接已经断开！"))
}
...
function output(a, b) {
    ...
    $("#div_msg").prepend("<div style='margin-bottom:10px;position:relative;left:0px;'>" + f + a + "</div>"),
    $("#div_msg").scrollTop(0)
}
