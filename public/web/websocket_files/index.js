				 ...
				 if (a.data instanceof Blob) {
					...
					var msg=JSON.parse(reader.result);
						if(msg.RC=="pong"){
							...
							var sendMsg={"genre":"check","data":msg.MsgID}
							ws.send(JSON.stringify(sendMsg))
							output(chg_emoji(msg.Content), 0)
						}  	
					}
				}		
            },
