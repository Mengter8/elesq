    ...
    public function qipao()
    {
        ...
        if ($arr = json_decode($data, true)){
            if (array_key_exists('ret', $arr) && $arr['ret'] == 0) {
                ...
                $this->msg[] = '气泡更换失败！需要SVIP';
            } elseif ($arr['ret'] == 4002) {
                $this->msg[] = '气泡更换失败！需要VIP';
            } elseif ($arr['ret'] == 9003) {
                $this->msg[] = '气泡更换失败！需要年费SVIP';
            } elseif ($arr['ret'] == 12002) {
                $this->msg[] = '气泡更换失败！需要大会员';
            } elseif ($arr['ret'] == 14002) {
                $this->msg[] = '气泡更换失败！需要续费SVIP活动';
